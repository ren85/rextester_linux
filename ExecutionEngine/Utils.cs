...
namespace ExecutionEngine
{
	public class Utils
	{
		...
		{
			if(lang == Languages.C || lang == Languages.CPP || lang == Languages.CClang || lang == Languages.CppClang || lang == Languages.Java || lang == Languages.Pascal || lang == Languages.Haskell || lang == Languages.ObjectiveC || lang == Languages.Nasm || lang == Languages.Go || lang == Languages.Scala)
				return true;
			else
				return false;
